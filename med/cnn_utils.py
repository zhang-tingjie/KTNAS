...
def uptate_parents_individual_list(input_individual_list, ga, num): # Set 0
    ...
    while len(input_individual_list) > i:
        ...
        if num == 1:
            ...
            ga.max_dict_3.update_2({ind: 0})
        elif num == 4:
            ga.max_dict_4.update_2({ind: 0})
        i += 1
...
def uptate_children_individual_list(input_individual_list, ga, num): # Set 0
    ...
    while len(input_individual_list) > i:
        ...
        if num == 1:
            ...
            ga.current_dict_3.update({ind: 0})
        elif num == 4:
            ga.current_dict_4.update({ind: 0})
        i += 1
...
def uptate_transferred_individual_list(input_individual_list, ga, num): # Set 0
    if num == 1:
        ...
        ga.transferred_dict_3 = PopulationDict()
    elif num == 4:
        ga.transferred_dict_4 = PopulationDict()
    ...
    while len(input_individual_list) > i:
        ...
        if num == 1:
            ...
            ga.transferred_dict_3.update({ind: 0})
        elif num == 4:
            ga.transferred_dict_4.update({ind: 0})
        i += 1
