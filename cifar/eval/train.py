...
parser.add_argument('--n_stack', type=int, default=3, help='normal cell stacking times')
...
def main():
  ...
  model = NewNetworkCIFAR(args.init_channels, CIFAR_CLASSES, args.auxiliary, genotype, args.n_stack)
  model = model.cuda()
